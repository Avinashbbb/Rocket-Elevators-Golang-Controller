...
func moveAllElevators(c *Column) {
	for i := 0; i < len(c.elevatorsList); i++ { //Parcours la liste d'ascenseur de la colonne
		for len(c.elevatorsList[i].floorRequestsList) != 0 { //Parcours la liste des requêtes de chaque ascenseur
